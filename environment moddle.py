...
NEWFOOD = 40
FOODSIZE = 20
BlueCow = pygame.image.load('BlueCow.bmp')
foods = []
for i in range(20):
...
while True:
    ...
    if BlueCow['dir'] == DOWNLEFT:
        BlueCow['rect'].left -= MOVESPEED
        BlueCow['rect'].top += MOVESPEED
    if BlueCow['dir'] == DOWNRIGHT:
        BlueCow['rect'].left += MOVESPEED
        BlueCow['rect'].top += MOVESPEED
    if BlueCow['dir'] == UPLEFT:
        BlueCow['rect'].left -= MOVESPEED
        BlueCow['rect'].top -= MOVESPEED
    if BlueCow['dir'] == UPRIGHT:
        BlueCow['rect'].left += MOVESPEED
        BlueCow['rect'].top -= MOVESPEED
